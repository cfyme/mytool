 ...
 *
 */
public class BalanceUnionDealToday {
	private static final Log log = LogFactory.getLog(BalanceUnionDealToday.class);
	...
	public static void executeList ( List<Map<String, Object>>  list){
		...
		for(Map<String, Object> map : list){
			...
			String sql = " SELECT\n" +
					...
					"        FROM\n" +
					"        fbs_merchant_union_balance_calculation\n" +
					"        WHERE\n" +
			...
			if(balance>0){
				sql = "update fbs_tmp_merchant_20171113 set union_balance='"+balance+"' where merchant_id='"+merchantId+"' ";
